...
def build_audit_package_pdf(kase: dict, logs: list[dict]) -> bytes:
    ...
    docs = [
        ...
        ("4", "RCGEN2 Macro Workbook", kase.get("bank_file_name") or "—", (kase.get("bank_file_hash") or "")[:32] + "…"),
        ("5", "RCgen TXT", kase.get("bank_receipt_name") or "Generated by maker (RCGEN2 → Generate)", ""),
